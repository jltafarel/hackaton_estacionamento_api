...
public class U {
	...
	public static <T extends Number> T coalesce(Number valor, T ouValor){
		...
		throw new IllegalArgumentException("O objeto "+ ouValor + " tem tipo inválido.");
	}
	
	
	public static Boolean coalesce(Boolean valor, Boolean ouValor){
		if (valor == null)
			return ouValor;
		 return valor;
	}
	 ...
	 * desde que o mesmo não seja nulo ou vazio
	 * @param object
	 * @return
	 */
